...
export default function Home() {
  ...
  const testLink = `${process.env.NEXT_PUBLIC_BASE_URL}/${codigo}/e-res/teste`
    ...
    <div className="ml-56 min-h-screen">
      ...
      <main className="p-10">
        ...
        <div className="glass p-6 rounded-xl max-w-2xl">
          ...
          <Link href={`/${codigo}/e-res/teste`} target="_blank" className="inline-block mt-4 text-primary underline">Abrir teste</Link>
        </div>
      </main>
      <UserBadge user={user} />
    </div>
